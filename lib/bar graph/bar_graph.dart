...
class MyBarGraph extends StatefulWidget {
  final List<double> monthlySummary; // [24$ per month , 500$ per month , ...]
...
class _MyBarGraphState extends State<MyBarGraph> {
  ...
  // initializa the bar Data -> used our monthlysummary to create list of bars
  ...
  double calcualteMax() {
    ...
    // get the month with the hieghest amount
    widget.monthlySummary.sort();

    // increase the upper limist by 5 %
  ...
  // scroll controller to make sure it scorlls to the latest month (our current month)
